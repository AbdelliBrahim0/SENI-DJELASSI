  ...
  head: () => ({
    meta: [
      ...
      { title: "SENI DJELASSI — Tout Corps d'État" },
      {
        name: "description",
        content:
          "Rénovation & BTP tout corps d'état à Marseille, Toulon et Nice. Devis gratuit.",
      },
      { name: "author", content: "SENI DJELASSI" },
      { property: "og:title", content: "SENI DJELASSI — Tout Corps d'État" },
      {
