import { r as METIERS, t as ENTREPRISE } from "./entreprise-CaGT3ssy.js";
import { n as Navbar, t as PiedDePage } from "./PiedDePage-D92gajDM.js";
import { t as useLenis } from "./use-lenis-DxbRzcjf.js";
import { useMemo, useState } from "react";
import { jsx, jsxs } from "react/jsx-runtime";
import { AnimatePresence, motion } from "motion/react";
import { ArrowLeft, ArrowRight, Check, Mail, MessageCircle, Phone } from "lucide-react";
//#region src/components/site/DevisWizard.tsx
var FORMULAIRES = {
	maconnerie: [
		{
			id: "typeTravaux",
...
function DevisWizard() {
	...
	const message = useMemo(() => genererMessage(metierId, reponses, contact), [
		metierId,
		reponses,
		contact
	]);
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx("div", {
			...
			children: ETAPES.map((e, i) => /* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", {
					...
					children: i < etape ? /* @__PURE__ */ jsx(Check, { className: "h-4 w-4" }) : e.numero
				}), /* @__PURE__ */ jsx("span", {
			...
			mode: "wait",
			children: [
				etape === 0 && /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						x: 30
					},
					...
					children: [
							...
							children: METIERS.map((m) => {
								...
								return /* @__PURE__ */ jsxs("button", {
									...
									children: [
										...
										actif && /* @__PURE__ */ jsx(motion.div, {
											layoutId: "check",
											className: "absolute right-3 top-3",
											children: /* @__PURE__ */ jsx(Check, { className: "h-4 w-4 text-primary" })
										})
									]
								}, m.id);
							})
						...
						/* @__PURE__ */ jsx("div", {
							...
							children: /* @__PURE__ */ jsxs("button", {
								...
								children: ["Suivant ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							})
						})
					]
				}, "e0"),
				etape === 1 && /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						x: 30
					},
					...
					children: [
						...
						/* @__PURE__ */ jsx("div", {
							className: "space-y-4",
							children: champs.map((champ) => /* @__PURE__ */ jsxs("div", { children: [/* @__PURE__ */ jsxs("label", {
								className: "mono-plan block text-xs",
								children: [
									champ.label,
									" ",
									champ.obligatoire && /* @__PURE__ */ jsx("span", {
										className: "text-primary",
										children: "*"
									})
								]
							}), champ.type === "select" ? /* @__PURE__ */ jsxs("select", {
								...
								}), champ.options?.map((o) => /* @__PURE__ */ jsx("option", {
									value: o,
									children: o
								}, o))]
							}) : champ.type === "textarea" ? /* @__PURE__ */ jsx("textarea", {
								value: reponses[champ.id] ?? "",
								onChange: (e) => majReponse(champ.id, e.target.value),
				...
				etape === 2 && /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						x: 30
					},
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("button", {
								...
								onClick: suivant,
								className: "mono-plan inline-flex items-center gap-2 rounded-sm bg-primary px-6 py-3 !text-primary-foreground transition-all duration-300 hover:bg-primary/90",
								children: ["Récapitulatif ", /* @__PURE__ */ jsx(ArrowRight, { className: "h-4 w-4" })]
							})]
						})
					]
				}, "e2"),
				etape === 3 && /* @__PURE__ */ jsxs(motion.div, {
					initial: {
						opacity: 0,
						x: 30
					},
					...
					children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", {
									...
									children: champs.filter((c) => reponses[c.id]?.trim()).map((c) => /* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										...
										/* @__PURE__ */ jsxs("p", {
											className: "text-muted-foreground",
											children: ["Tél : ", /* @__PURE__ */ jsx("span", {
												className: "text-marbre",
												children: contact.telephone
											})]
										}),
										contact.email && /* @__PURE__ */ jsxs("p", {
											className: "text-muted-foreground",
						...
						!envoye ? /* @__PURE__ */ jsxs("div", {
								...
								/* @__PURE__ */ jsxs("div", {
									...
									children: [
										/* @__PURE__ */ jsxs("a", {
											...
											children: [/* @__PURE__ */ jsx(MessageCircle, { className: "h-5 w-5 text-primary" }), " WhatsApp"]
										}),
										/* @__PURE__ */ jsxs("a", {
											href: lienEmail,
											onClick: () => setEnvoye(true),
											...
											children: [/* @__PURE__ */ jsx(Mail, { className: "h-5 w-5" }), " Email"]
										}),
										/* @__PURE__ */ jsxs("a", {
											href: ENTREPRISE.telephoneLien,
											className: "mono-plan flex flex-1 items-center justify-center gap-2 rounded-sm border border-border px-6 py-4 text-sm transition-all duration-300 hover:border-primary/30 hover:!text-primary",
											children: [/* @__PURE__ */ jsx(Phone, { className: "h-5 w-5" }), " Appeler"]
										})
									]
								}),
								/* @__PURE__ */ jsx("div", {
							...
							children: [
								/* @__PURE__ */ jsx(Check, { className: "mx-auto h-10 w-10 text-primary" }),
								/* @__PURE__ */ jsx("p", {
...
//#endregion
//#region src/routes/demande-devis.tsx?tsr-split=component
	...
	return /* @__PURE__ */ jsxs("main", {
		...
		children: [
			...
			/* @__PURE__ */ jsx("section", {
				...
				children: /* @__PURE__ */ jsx(DevisWizard, {})
			}),
			/* @__PURE__ */ jsx(PiedDePage, {})
		]
	});
}
//#endregion
